...
type DiscountErrorCode int32

const (
	DiscountErrorCode_DISCOUNT_ERROR_CODE_NONE           DiscountErrorCode = 0
	DiscountErrorCode_DISCOUNT_ERROR_CODE_INVALID        DiscountErrorCode = 1
	DiscountErrorCode_DISCOUNT_ERROR_CODE_EXPIRED        DiscountErrorCode = 2
	DiscountErrorCode_DISCOUNT_ERROR_CODE_NOT_APPLICABLE DiscountErrorCode = 3
	DiscountErrorCode_DISCOUNT_ERROR_CODE_LIMIT_REACHED  DiscountErrorCode = 4
)

// Enum value maps for DiscountErrorCode.
var (
	DiscountErrorCode_name = map[int32]string{
		0: "DISCOUNT_ERROR_CODE_NONE",
		1: "DISCOUNT_ERROR_CODE_INVALID",
		2: "DISCOUNT_ERROR_CODE_EXPIRED",
		3: "DISCOUNT_ERROR_CODE_NOT_APPLICABLE",
		4: "DISCOUNT_ERROR_CODE_LIMIT_REACHED",
	}
	DiscountErrorCode_value = map[string]int32{
		"DISCOUNT_ERROR_CODE_NONE":           0,
		"DISCOUNT_ERROR_CODE_INVALID":        1,
		"DISCOUNT_ERROR_CODE_EXPIRED":        2,
		"DISCOUNT_ERROR_CODE_NOT_APPLICABLE": 3,
		"DISCOUNT_ERROR_CODE_LIMIT_REACHED":  4,
	}
)

func (x DiscountErrorCode) Enum() *DiscountErrorCode {
	p := new(DiscountErrorCode)
	*p = x
	return p
}

func (x DiscountErrorCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DiscountErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_demo_proto_enumTypes[0].Descriptor()
}

func (DiscountErrorCode) Type() protoreflect.EnumType {
	return &file_demo_proto_enumTypes[0]
}

func (x DiscountErrorCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DiscountErrorCode.Descriptor instead.
func (DiscountErrorCode) EnumDescriptor() ([]byte, []int) {
...
type ApplyDiscountRequest struct {
	...
	CartTotal     *Money                 `protobuf:"bytes,2,opt,name=cart_total,json=cartTotal,proto3" json:"cart_total,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ApplyDiscountRequest) GetCartTotal() *Money {
	if x != nil {
		return x.CartTotal
	}
	return nil
...
type ApplyDiscountResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	DiscountAmount *Money                 `protobuf:"bytes,1,opt,name=discount_amount,json=discountAmount,proto3" json:"discount_amount,omitempty"`
	FinalTotal     *Money                 `protobuf:"bytes,2,opt,name=final_total,json=finalTotal,proto3" json:"final_total,omitempty"`
	ErrorCode      DiscountErrorCode      `protobuf:"varint,3,opt,name=error_code,json=errorCode,proto3,enum=hipstershop.DiscountErrorCode" json:"error_code,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ApplyDiscountResponse) GetDiscountAmount() *Money {
	if x != nil {
...
func (x *ApplyDiscountResponse) GetFinalTotal() *Money {
	if x != nil {
		return x.FinalTotal
	}
	return nil
...
func (x *ApplyDiscountResponse) GetErrorCode() DiscountErrorCode {
	if x != nil {
		return x.ErrorCode
	}
	return DiscountErrorCode_DISCOUNT_ERROR_CODE_NONE
}
...
func (x *OrderResult) GetTotalPaid() *Money {
	if x != nil {
		return x.TotalPaid
	}
	return nil
...
const file_demo_proto_rawDesc = "" +
	...
	"\ato_code\x18\x02 \x01(\tR\x06toCode\"n\n" +
	"\x14ApplyDiscountRequest\x12#\n" +
	"\rdiscount_code\x18\x01 \x01(\tR\fdiscountCode\x121\n" +
	"\n" +
	"cart_total\x18\x02 \x01(\v2\x12.hipstershop.MoneyR\tcartTotal\"\xc8\x01\n" +
	"\x15ApplyDiscountResponse\x12;\n" +
	"\x0fdiscount_amount\x18\x01 \x01(\v2\x12.hipstershop.MoneyR\x0ediscountAmount\x123\n" +
	"\vfinal_total\x18\x02 \x01(\v2\x12.hipstershop.MoneyR\n" +
	"finalTotal\x12=\n" +
	"\n" +
	"error_code\x18\x03 \x01(\x0e2\x1e.hipstershop.DiscountErrorCodeR\terrorCode\"\xe6\x01\n" +
	...
	"\x04cost\x18\x02 \x01(\v2\x12.hipstershop.MoneyR\x04cost\"\xf2\x02\n" +
	...
	"\x0fdiscount_amount\x18\x06 \x01(\v2\x12.hipstershop.MoneyR\x0ediscountAmount\x121\n" +
	"\n" +
	"total_paid\x18\a \x01(\v2\x12.hipstershop.MoneyR\ttotalPaid\"d\n" +
	"\x1cSendOrderConfirmationRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12.\n" +
	"\x05order\x18\x02 \x01(\v2\x18.hipstershop.OrderResultR\x05order\"\xfa\x01\n" +
	...
	"\rdiscount_code\x18\x04 \x01(\tR\fdiscountCode\x12\x14\n" +
	...
	"\x11DiscountErrorCode\x12\x1c\n" +
	"\x18DISCOUNT_ERROR_CODE_NONE\x10\x00\x12\x1f\n" +
	"\x1bDISCOUNT_ERROR_CODE_INVALID\x10\x01\x12\x1f\n" +
	"\x1bDISCOUNT_ERROR_CODE_EXPIRED\x10\x02\x12&\n" +
	"\"DISCOUNT_ERROR_CODE_NOT_APPLICABLE\x10\x03\x12%\n" +
	"!DISCOUNT_ERROR_CODE_LIMIT_REACHED\x10\x042\xca\x01\n" +
	"\vCartService\x12<\n" +
	...
	"\aConvert\x12&.hipstershop.CurrencyConversionRequest\x1a\x12.hipstershop.Money\"\x002o\n" +
	"\x13DiscountCodeService\x12X\n" +
	"\rApplyDiscount\x12!.hipstershop.ApplyDiscountRequest\x1a\".hipstershop.ApplyDiscountResponse\"\x002U\n" +
...
var file_demo_proto_goTypes = []any{
	(DiscountErrorCode)(0),                 // 0: hipstershop.DiscountErrorCode
	...
	(*ApplyDiscountRequest)(nil),           // 22: hipstershop.ApplyDiscountRequest
	(*ApplyDiscountResponse)(nil),          // 23: hipstershop.ApplyDiscountResponse
	(*CreditCardInfo)(nil),                 // 24: hipstershop.CreditCardInfo
	(*ChargeRequest)(nil),                  // 25: hipstershop.ChargeRequest
	...
	(*PlaceOrderRequest)(nil),              // 30: hipstershop.PlaceOrderRequest
	(*PlaceOrderResponse)(nil),             // 31: hipstershop.PlaceOrderResponse
	(*AdRequest)(nil),                      // 32: hipstershop.AdRequest
	(*AdResponse)(nil),                     // 33: hipstershop.AdResponse
	(*Ad)(nil),                             // 34: hipstershop.Ad
}
var file_demo_proto_depIdxs = []int32{
	...
	19, // 11: hipstershop.ApplyDiscountRequest.cart_total:type_name -> hipstershop.Money
	19, // 12: hipstershop.ApplyDiscountResponse.discount_amount:type_name -> hipstershop.Money
	19, // 13: hipstershop.ApplyDiscountResponse.final_total:type_name -> hipstershop.Money
	0,  // 14: hipstershop.ApplyDiscountResponse.error_code:type_name -> hipstershop.DiscountErrorCode
	19, // 15: hipstershop.ChargeRequest.amount:type_name -> hipstershop.Money
	24, // 16: hipstershop.ChargeRequest.credit_card:type_name -> hipstershop.CreditCardInfo
	1,  // 17: hipstershop.OrderItem.item:type_name -> hipstershop.CartItem
	19, // 18: hipstershop.OrderItem.cost:type_name -> hipstershop.Money
	19, // 19: hipstershop.OrderResult.shipping_cost:type_name -> hipstershop.Money
	18, // 20: hipstershop.OrderResult.shipping_address:type_name -> hipstershop.Address
	27, // 21: hipstershop.OrderResult.items:type_name -> hipstershop.OrderItem
	19, // 22: hipstershop.OrderResult.discount_amount:type_name -> hipstershop.Money
	19, // 23: hipstershop.OrderResult.total_paid:type_name -> hipstershop.Money
	28, // 24: hipstershop.SendOrderConfirmationRequest.order:type_name -> hipstershop.OrderResult
	18, // 25: hipstershop.PlaceOrderRequest.address:type_name -> hipstershop.Address
	24, // 26: hipstershop.PlaceOrderRequest.credit_card:type_name -> hipstershop.CreditCardInfo
	28, // 27: hipstershop.PlaceOrderResponse.order:type_name -> hipstershop.OrderResult
	34, // 28: hipstershop.AdResponse.ads:type_name -> hipstershop.Ad
	2,  // 29: hipstershop.CartService.AddItem:input_type -> hipstershop.AddItemRequest
	4,  // 30: hipstershop.CartService.GetCart:input_type -> hipstershop.GetCartRequest
	3,  // 31: hipstershop.CartService.EmptyCart:input_type -> hipstershop.EmptyCartRequest
	7,  // 32: hipstershop.RecommendationService.ListRecommendations:input_type -> hipstershop.ListRecommendationsRequest
	6,  // 33: hipstershop.ProductCatalogService.ListProducts:input_type -> hipstershop.Empty
	11, // 34: hipstershop.ProductCatalogService.GetProduct:input_type -> hipstershop.GetProductRequest
	12, // 35: hipstershop.ProductCatalogService.SearchProducts:input_type -> hipstershop.SearchProductsRequest
	14, // 36: hipstershop.ShippingService.GetQuote:input_type -> hipstershop.GetQuoteRequest
	16, // 37: hipstershop.ShippingService.ShipOrder:input_type -> hipstershop.ShipOrderRequest
	6,  // 38: hipstershop.CurrencyService.GetSupportedCurrencies:input_type -> hipstershop.Empty
	21, // 39: hipstershop.CurrencyService.Convert:input_type -> hipstershop.CurrencyConversionRequest
	22, // 40: hipstershop.DiscountCodeService.ApplyDiscount:input_type -> hipstershop.ApplyDiscountRequest
	25, // 41: hipstershop.PaymentService.Charge:input_type -> hipstershop.ChargeRequest
	29, // 42: hipstershop.EmailService.SendOrderConfirmation:input_type -> hipstershop.SendOrderConfirmationRequest
	30, // 43: hipstershop.CheckoutService.PlaceOrder:input_type -> hipstershop.PlaceOrderRequest
	32, // 44: hipstershop.AdService.GetAds:input_type -> hipstershop.AdRequest
	6,  // 45: hipstershop.CartService.AddItem:output_type -> hipstershop.Empty
	5,  // 46: hipstershop.CartService.GetCart:output_type -> hipstershop.Cart
	6,  // 47: hipstershop.CartService.EmptyCart:output_type -> hipstershop.Empty
	8,  // 48: hipstershop.RecommendationService.ListRecommendations:output_type -> hipstershop.ListRecommendationsResponse
	10, // 49: hipstershop.ProductCatalogService.ListProducts:output_type -> hipstershop.ListProductsResponse
	9,  // 50: hipstershop.ProductCatalogService.GetProduct:output_type -> hipstershop.Product
	13, // 51: hipstershop.ProductCatalogService.SearchProducts:output_type -> hipstershop.SearchProductsResponse
	15, // 52: hipstershop.ShippingService.GetQuote:output_type -> hipstershop.GetQuoteResponse
	17, // 53: hipstershop.ShippingService.ShipOrder:output_type -> hipstershop.ShipOrderResponse
	20, // 54: hipstershop.CurrencyService.GetSupportedCurrencies:output_type -> hipstershop.GetSupportedCurrenciesResponse
	19, // 55: hipstershop.CurrencyService.Convert:output_type -> hipstershop.Money
	23, // 56: hipstershop.DiscountCodeService.ApplyDiscount:output_type -> hipstershop.ApplyDiscountResponse
	26, // 57: hipstershop.PaymentService.Charge:output_type -> hipstershop.ChargeResponse
	6,  // 58: hipstershop.EmailService.SendOrderConfirmation:output_type -> hipstershop.Empty
	31, // 59: hipstershop.CheckoutService.PlaceOrder:output_type -> hipstershop.PlaceOrderResponse
	33, // 60: hipstershop.AdService.GetAds:output_type -> hipstershop.AdResponse
